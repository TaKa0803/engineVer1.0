...
#pragma region マスク画像
	...
	descriptorRangeMask[0].BaseShaderRegister = 1;								//0から始まる
	descriptorRangeMask[0].NumDescriptors = 1;									//数
	...
	rootParameters[2].DescriptorTable.pDescriptorRanges = descriptorRangeMask;				//tableの中身の配列を指定
	rootParameters[2].DescriptorTable.NumDescriptorRanges = _countof(descriptorRangeMask);	//tableで利用する
#pragma endregion
