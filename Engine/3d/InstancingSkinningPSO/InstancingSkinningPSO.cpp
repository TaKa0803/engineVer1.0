#include "InstancingSkinningPSO.h"
...
#pragma region Worldデータをsrv管理
	...
	descriptorRangeForInstancing[0].NumDescriptors = 2;
...
#pragma endregion
	...
	Log("Complete Instancing Skinning GraphicsSystem Initialize\n");

}

void InstancingSkinningPSO::PreDraw(const FillMode& fillMode, const BlendMode& blendMode)
{
